// Account lifecycle builders — folded into the wallet engine from the former
// @loom/account package (task 8): one client, one package. Pure and offline;
// the calldata encoder stays pinned byte-for-byte to the contracts by
// test/fixtures/sdk-calldata.json and its Solidity differential.
