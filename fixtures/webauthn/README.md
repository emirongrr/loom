...
- capture date and WebAuthn behavior notes.
...
validates committed fixture shape without pretending missing hardware exists.
...
remove unnecessary browser metadata before review. A fixture is accepted only
after its positive and mutation-negative Foundry tests pass.
