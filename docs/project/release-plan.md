...
| 6 | Sovereign exit V2 | 1-5 | separately audited direct execution and permissionless migration |
...
tests but lacks two live independent bundlers. Slice 6 remains design-only.
