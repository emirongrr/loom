...
const safeRepositoryPath = repoRoot.replaceAll("\\", "/").replace(/\/+$/u, "");
const git = args => execFileSync("git", ["-c", `safe.directory=${safeRepositoryPath}`, ...args], { cwd: repoRoot, encoding: "utf8" });
