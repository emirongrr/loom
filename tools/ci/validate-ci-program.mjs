...
function validateContractsWorkflow() {
  ...
  for (const required of [
    ...
    "forge build --sizes",
    'forge snapshot --force --check --tolerance 1 --no-match-contract ".*Formal|MainnetTokenCompatibilityForkTest|OPStackL1BlockPredeployForkTest|MultiP256ValidatorTest|P256VerifierConfigTest|WebAuthnFixtureCorpusTest|WebAuthnEntryPointLifecycleIntegrationTest" --no-match-path "test/{formal,invariant,script}/**"',
